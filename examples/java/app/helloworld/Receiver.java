...
public class Receiver extends Process {
	...
	public Receiver(String hostname, String name, String receiverHostname) throws HostNotFoundException {
		super(hostname, name);
		this.receiverHostname = receiverHostname;
	}

	public void main(String[] args) throws MsgException {
		MyTask task = (MyTask)Task.receive(getHost().getName());
		...
		task = new MyTask("world", 0, COMM_SIZE_LAT);
		task.send(hostname);
		Msg.info("Done.");
	}
}